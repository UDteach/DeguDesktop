...
- Added regression tests for updater path constraints, PowerShell-free runtime updater command construction, release workflow PowerShell parsing, package hash/security-manifest coverage, and Win32 resource workflow coverage.
